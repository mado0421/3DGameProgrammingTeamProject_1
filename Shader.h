...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera);
	virtual CGameObject** GetObjectsPointer() { return m_ppObjects; }
	virtual int GetObjectsCount() { return m_nObjects; }
protected:
...
class CMazeObjectShader : public CObjectsShader
{
public:
	virtual D3D12_INPUT_LAYOUT_DESC CreateInputLayout();
	virtual D3D12_SHADER_BYTECODE CreateVertexShader(ID3DBlob **ppd3dShaderBlob);
...
public:
	...
	int m_nBillBoardVariables=1;
	int *m_pBillBoardVarIndex;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CTextureTerrainShader : public CShader
{
protected:
	ID3D12Resource					*m_pd3dcbGameObjects = NULL;
	UINT8							*m_pcbMappedGameObjects = NULL;
public:
	CTextureTerrainShader();
	virtual ~CTextureTerrainShader();
